			...
			<div class="container">
				<div class="header-row flex-column flex-lg-row justify-content-center justify-content-lg-start">
					...
					<div id="logo" class="mr-0 mr-lg-auto">
						<a href="index.php" class="standard-logo" data-dark-logo="images/logo.JPG"><img src="images/logo.JPG" alt="RiohVeritas Logo"></a>
						<a href="index.php" class="retina-logo" data-dark-logo="images/logo.JPG"><img src="images/logo.JPG" alt="RiohVeritas Logo"></a>
					</div><!-- #logo end -->
					...
					<div class="header-misc mb-4 mb-lg-0 order-lg-last">
						...
						<ul class="header-extras mr-0 mr-sm-4">
							<li>
								...
								<div class="he-text">
									Drop an Email
									<span>connect@riohveritas.com</span>
								</div>
							</li>
							<li>
