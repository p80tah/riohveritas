				...
				<div class="container">
					<div class="header-row">
						...
						<div id="logo" class="mr-lg-3">
							...
							<a href="index.html" class="retina-logo" data-dark-logo="one-page/images/canvasone-dark@2x.png"><img src="one-page/images/canvasone%402x.png" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
					...
					<div class="container py-5">
						<div class="row">
							<div class="col-lg-4">
								...
								<h2 class="ls0 font-weight-bold text-uppercase" style="font-size: 26px;">Your House is not an Asset,<br>It's a Liability.</h2>
								<h3 class="font-weight-light" style="font-size: 20px;">Everyone wants a piece of land. It’s the only sure investment. It can never depreciate like a car or washing machine. Land will only double its value in ten years.</h3>
								<a href="#" class="button button-circle button-border button-dark button-black button-large text-right m-0 clearfix" data-scrollto="#section-about" data-offset="60">Let's Go Inside<i class="icon-line-arrow-down"></i></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container clearfix">
						...
						<div class="mx-auto topmargin" style="max-width: 850px;">
							...
							<div class="form-widget">
								...
								<form class="row mb-0" id="template-contactform" name="template-contactform" action="http://themes.semicolonweb.com/html/canvas/include/form.php" method="post">
...
<!-- Mirrored from themes.semicolonweb.com/html/canvas/op-apartment.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Oct 2020 15:46:49 GMT -->
</html>